...
const MovieDetails = () => {
    ...
    const {shows,axios,getToken,user,fetchFavoriteMovies,favouriteMovies,image_base_url}=useAppContext()
  ...
  return show ?(
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
        ...
        <div className='relative flex flex-col gap-3'>
            ...
            <p>
                {Array.isArray(show.movie.genres)? show.movie.genres.map(g => (typeof g === "string" ? g : g.name)).join(", "): ""} .{show.movie.release_date.split("-")[0]}
            </p>
            ...
            <Heart
                onClick={() => toggleFavourite(movie)}
                 className={`cursor-pointer w-5 h-5 transition-colors duration-200 
    ${favouriteMovies?.some(fav => fav?._id === movie._id)
