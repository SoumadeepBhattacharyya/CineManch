...
const releasedSeatsAndDeleteBooking=inngest.createFunction(
            ...
            return await Promise.allSettled(
                remainderTasks.map(task=>sendEmail({
                    ...
                    body:`<div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <br/>
                            <p>Enjoy the show!<br/>CineManch Team</p>
                        </div>`
                }))
            )
        })
    ...
    async({event})=>{
        ...
        for(const user of users){
            ...
            const body=`<div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <p>👉 <a href="https://yourdomain.com" style="color: #007bff; text-decoration: none;">Visit our website</a> to watch it now!</p>
                            <br/>
                            <p>Thanks,<br/>CineManch Team</p>
                        </div>`;
